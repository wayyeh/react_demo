...
类型检查通常是必须的，它能让你快速地检测和捕获应用的bug。

### prop-types

[prop-types](https://github.com/facebook/prop-types) 是react提供的一个用于类型检查的包，它可以检测react组件`props`属性的合法性。
